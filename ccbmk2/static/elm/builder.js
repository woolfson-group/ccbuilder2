	...
	function (panel, currentVisibility) {
		...
		switch (_p1.ctor) {
			case 'BuildPanel':
				return _elm_lang$core$Native_Utils.update(
					currentVisibility,
					{buildPanel: !currentVisibility.buildPanel, examplesPanel: false});
			case 'ExamplesPanel':
				return _elm_lang$core$Native_Utils.update(
					currentVisibility,
					{buildPanel: false, examplesPanel: !currentVisibility.examplesPanel});
...
var _user$project$Builder$viewerPanel = A2(
	_elm_lang$html$Html$div,
	{
		ctor: '::',
		_0: _user$project$Builder$class(
	...
	var activeDivs = _elm_lang$core$Tuple$second(
		_elm_lang$core$List$unzip(
			A2(
				_elm_lang$core$List$filter,
				function (opt) {
					return _elm_lang$core$Tuple$first(opt);
				},
				optionalDivs)));
	var defaultDivs = {
		ctor: '::',
...
var _user$project$Builder$setStorage = _elm_lang$core$Native_Platform.outgoingPort(
	...
	function (v) {
		return {
			...
			panelVisibility: {buildPanel: v.panelVisibility.buildPanel, examplesPanel: v.panelVisibility.examplesPanel, buildHistoryPanel: v.panelVisibility.buildHistoryPanel, viewerPanel: v.panelVisibility.viewerPanel},
																											...
																											return A2(
																												...
																												function (score) {
																													return _elm_lang$core$Json_Decode$succeed(
																														{building: building, currentInput: currentInput, currentRepresentation: currentRepresentation, modelHistory: modelHistory, nextHistoryID: nextHistoryID, oligomericState: oligomericState, panelVisibility: panelVisibility, parameterClipBoard: parameterClipBoard, parameters: parameters, pdbFile: pdbFile, residuesPerTurn: residuesPerTurn, score: score});
																												},
																												A2(
																													_elm_lang$core$Json_Decode$field,
																													'score',
																								...
																								function (examplesPanel) {
																									return A2(
																										...
																										function (viewerPanel) {
																											return _elm_lang$core$Json_Decode$succeed(
																												{buildHistoryPanel: buildHistoryPanel, buildPanel: buildPanel, examplesPanel: examplesPanel, viewerPanel: viewerPanel});
																										},
							...
							return function (h) {
								return function (i) {
									return function (j) {
										return function (k) {
											return function (l) {
												return {parameters: a, currentInput: b, parameterClipBoard: c, oligomericState: d, pdbFile: e, score: f, residuesPerTurn: g, building: h, modelHistory: i, nextHistoryID: j, panelVisibility: k, currentRepresentation: l};
											};
										};
									};
								};
