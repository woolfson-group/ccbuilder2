	...
	_1: {
		...
		_1: {
			...
			_1: {
				...
				_1: {
					ctor: '::',
					_0: {ctor: '_Tuple2', _0: 'Sequence', _1: _user$project$Types$Sequence},
					_1: {ctor: '[]'}
				}
			}
		}
...
var _user$project$Builder$parameterInput = function (_p2) {
	...
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('input-parameter'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
...
if (typeof _user$project$Builder$main !== 'undefined') {
    _user$project$Builder$main(Elm['Builder'], 'Builder', undefined);
}
