...
sudo docker run -d -v /fs/users/cw12401/web/ccbuilder2/optimisation/:/app -e PYTHONUNBUFFERED=0 -e OPT_PROCS=2 --link ccbmk2_db_1:db --name ccbmk2_optimisation_1 ccbmk2_optimisation
