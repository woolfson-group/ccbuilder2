	...
	function (msg, model) {
		...
		switch (_p2.ctor) {
			case 'EditSingleParameter':
				...
				var _p3 = A4(_user$project$ParameterValidation$editParameterValue, params, input, _p2._0, _p2._2);
				var p = _p3._0;
				var i = _p3._1;
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					...
					_elm_lang$core$Native_Utils.update(
						model,
						{
							activeInfoBox: function () {
								var _p25 = model.activeInfoBox;
								if (_p25.ctor === 'Just') {
									return _elm_lang$core$Native_Utils.eq(_p26, _p25._0) ? _elm_lang$core$Maybe$Nothing : _elm_lang$core$Maybe$Just(_p26);
								} else {
