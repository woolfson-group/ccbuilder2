...
var _user$project$Types$CloseInfo = function (a) {
	return {ctor: 'CloseInfo', _0: a};
};
...
var _user$project$Types$ClearOptimisation = function (a) {
	return {ctor: 'ClearOptimisation', _0: a};
};
var _user$project$Types$RetrieveOptimisation = function (a) {
	return {ctor: 'RetrieveOptimisation', _0: a};
};
var _user$project$Types$OptJobStatus = F2(
	function (a, b) {
		return {ctor: 'OptJobStatus', _0: a, _1: b};
	});
...
var _user$project$Types$MIHLKnobs = {ctor: 'MIHLKnobs'};
var _user$project$Types$MIRPT = {ctor: 'MIRPT'};
var _user$project$Types$MIBudeEnergy = {ctor: 'MIBudeEnergy'};
...
var _user$project$BuildPanel$singleRegisterSelection = F2(
...
var _user$project$BuildPanel$allRegisterSelection = F2(
	function (sectionID, currentRegister) {
		return A2(
			_elm_lang$html$Html$select,
			{
				...
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html_Events$onInput(
						_user$project$Types$EditAllParameters(_user$project$Types$Register)),
					_1: {ctor: '[]'}
				}
			},
			A2(
					...
					function () {
						...
						if (_p8.ctor === 'Alpha') {
							return {
								...
								_1: {
									ctor: '::',
									_0: A2(_user$project$BuildPanel$allRegisterSelection, 1, _p7._3),
									_1: {
										ctor: '::',
					...
					function () {
						...
						if (_p18.ctor === 'Alpha') {
							return {
								...
								_1: {
									ctor: '::',
									_0: A2(_user$project$BuildPanel$singleRegisterSelection, sectionID, _p17._3),
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html$text(')'),
										_1: {ctor: '[]'}
													...
													return function (n) {
														return function (o) {
															return function (p) {
																return function (q) {
																	return function (r) {
																		return {parameters: a, currentInput: b, parameterClipBoard: c, oligomericState: d, helixType: e, buildMode: f, pdbFile: g, score: h, residuesPerTurn: i, knobIDs: j, building: k, optJobs: l, heat: m, modelHistory: n, nextHistoryID: o, panelVisibility: p, currentRepresentation: q, activeInfoBoxes: r};
																	};
																};
															};
														};
...
var _user$project$Update$basicParameterJsonDecoder = A6(
	...
	A2(_elm_lang$core$Json_Decode$field, 'phiCA', _elm_lang$core$Json_Decode$float),
...
var _user$project$Update$checkJobStatus = function (optJobId) {
	return A2(
		...
		_user$project$Types$OptJobStatus(optJobId),
		A2(
...
var _user$project$Update$update = F2(
	function (msg, model) {
		...
		switch (_p2.ctor) {
					...
					var newOptJobs = _elm_lang$core$Dict$toList(
						A3(
							...
							A2(
								_elm_lang$core$Result$withDefault,
								_user$project$Types$Failed,
								_user$project$Types$stringToOptStatus(_p2._1._0._1)),
					...
					_elm_lang$core$Native_Utils.update(
						model,
						{
							optJobs: A2(
								...
								function (_p20) {
									var _p21 = _p20;
									return !_elm_lang$core$Native_Utils.eq(_p21._0, _p2._0);
								},
								model.optJobs)
						}),
					{ctor: '[]'});
			case 'ProcessModel':
				if (_p2._0.ctor === 'Ok') {
					var _p24 = _p2._0._0.score;
					var _p23 = _p2._0._0.pdbFile;
					var _p22 = _p2._0._0.knobIDs;
					var helixType = A2(
						_elm_lang$core$Result$withDefault,
						_user$project$Types$Alpha,
					...
					return A2(
						...
						_elm_lang$core$Native_Utils.update(
							model,
							{
								...
								knobIDs: _elm_lang$core$Maybe$Just(_p22),
								building: false,
								modelHistory: A3(
									_elm_lang$core$Dict$insert,
									model.nextHistoryID,
									{ctor: '_Tuple6', _0: model.parameters, _1: false, _2: _p24, _3: helixType, _4: _user$project$Types$Basic, _5: _p22},
									oldHistory),
			...
			case 'ProcessOptimisation':
				if (_p2._0.ctor === 'Ok') {
					var _p26 = _p2._0._0.parameters;
					var _p25 = _p2._0._0.oligomericState;
					var fullParameters = {
						radius: _p26.radius,
						pitch: _p26.pitch,
						phiCA: _p26.phiCA,
						sequence: _p26.sequence,
						register: _p26.register,
						antiParallel: false,
						linkedSuperHelRot: true,
					...
					var parametersDict = _elm_lang$core$Dict$fromList(
						A3(
							...
							A2(_elm_lang$core$List$range, 1, _p25),
							A2(_elm_lang$core$List$repeat, _p25, fullParameters)));
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						_elm_lang$core$Native_Utils.update(
							model,
			...
			case 'SetParametersAndBuild':
				var _p27 = _p2._0;
				return _user$project$ParameterValidation$invalidParameterDict(_p27) ? A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					model,
					{ctor: '[]'}) : A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					_elm_lang$core$Native_Utils.update(
						model,
						{
							...
							buildMode: _p2._2,
							parameters: _p27,
							currentInput: _user$project$Types$parametersDictToInputDict(_p27),
							oligomericState: _elm_lang$core$List$length(
								_elm_lang$core$Dict$toList(_p27))
						}),
					{
						ctor: '::',
			...
			case 'ExpandHistory':
				var _p30 = _p2._0;
				var oldEntry = A2(_elm_lang$core$Dict$get, _p30, model.modelHistory);
				var _p29 = oldEntry;
				if (_p29.ctor === 'Just') {
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						_elm_lang$core$Native_Utils.update(
							model,
							{
								modelHistory: A3(
									_elm_lang$core$Dict$insert,
									_p30,
									{ctor: '_Tuple6', _0: _p29._0._0, _1: !_p29._0._1, _2: _p29._0._2, _3: _p29._0._3, _4: _p29._0._4, _5: _p29._0._5},
									model.modelHistory)
							}),
						{ctor: '[]'});
				} else {
			...
			case 'ShowInfo':
				return A2(
					...
					_elm_lang$core$Native_Utils.update(
						model,
						{
							activeInfoBoxes: {ctor: '::', _0: _p2._0, _1: model.activeInfoBoxes}
						}),
					{ctor: '[]'});
			case 'CloseInfo':
				return A2(
					...
					_elm_lang$core$Native_Utils.update(
						model,
						{
							activeInfoBoxes: A2(
								_elm_lang$core$List$filter,
								function (x) {
									return !_elm_lang$core$Native_Utils.eq(x, _p2._0);
								},
								model.activeInfoBoxes)
						}),
					{ctor: '[]'});
			default:
				return A2(
...
var _user$project$Views$infoText = F2(
	function (infoBoxID, contentText) {
		return A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html$text(contentText),
				_1: {ctor: '[]'}
			});
	});
...
var _user$project$Views$infoBoxStyling = {
	ctor: '::',
	_0: _rtfeldman$elm_css$Css$maxWidth(
		_rtfeldman$elm_css$Css$pct(40)),
	_1: {
...
var _user$project$Views$highlightKIHText = 'Highlights knob residues red, all other residues are coloured blue.';
var _user$project$Views$mIRPTText = 'Residues per turn of the alpha helix, can be used as a proxy for backbone strain.';
var _user$project$Views$mIBudeEnergyText = 'The interaction energy between helices as calculated by the BUDE force field implemented in the BUFF module of ISAMBARD.';
...
var _user$project$Views$optimisePanel = function (model) {
	var totalResidueCount = _elm_lang$core$List$sum(
		A2(
			_elm_lang$core$List$map,
	...
	var disabledOpt = advancedBuild || (optimising || aboveResLimit);
	var visible = model.panelVisibility.optimisePanel;
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
								...
								A2(
									...
									A2(
										...
										A2(
											...
											A2(_elm_lang$core$Basics_ops['++'], 'consider using [ISAMBARD](https://github.', 'com/woolfson-group/isambard).'))))),
							_1: {ctor: '[]'}
						}
					}
				} : (aboveResLimit ? {
...
var _user$project$Views$budeEnergyInfo = A2(
	_elm_lang$html$Html$div,
	{
		ctor: '::',
		_0: _user$project$Views$class(
		...
		_1: {
			ctor: '::',
			_0: _user$project$Views$styles(_user$project$Views$infoBoxStyling),
			_1: {ctor: '[]'}
		}
	},
	{
		...
		_1: {
			ctor: '::',
			_0: _elm_lang$html$Html$text(_user$project$Views$mIBudeEnergyText),
			_1: {ctor: '[]'}
		}
	});
var _user$project$Views$rptInfo = A2(
	_elm_lang$html$Html$div,
	{
		ctor: '::',
		_0: _user$project$Views$class(
	...
	},
	{
		...
		_1: {
			ctor: '::',
			_0: _elm_lang$html$Html$text(_user$project$Views$mIRPTText),
			_1: {ctor: '[]'}
		}
	});
var _user$project$Views$highlightKIHInfo = A2(
	_elm_lang$html$Html$div,
	{
		ctor: '::',
		_0: _user$project$Views$class(
	...
	},
	{
		...
		_1: {
			ctor: '::',
			_0: _elm_lang$html$Html$text(_user$project$Views$highlightKIHText),
			_1: {ctor: '[]'}
		}
	});
...
var _user$project$Views$modelInfoGroup = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			...
			_1: {
				ctor: '::',
				_0: _user$project$Views$styles(
					A2(_elm_lang$core$Basics_ops['++'], _user$project$Views$modelInfoGroupPanelStyling, _user$project$BuilderCss$panelStyling)),
				_1: {ctor: '[]'}
			}
		},
		A2(
			...
			A2(_elm_lang$core$List$member, _user$project$Types$MIBudeEnergy, model.activeInfoBoxes) ? {
				ctor: '::',
				_0: _user$project$Views$budeEnergyInfo,
				_1: {ctor: '[]'}
			} : (A2(_elm_lang$core$List$member, _user$project$Types$MIRPT, model.activeInfoBoxes) ? {
				ctor: '::',
				_0: _user$project$Views$rptInfo,
				_1: {ctor: '[]'}
			} : (A2(_elm_lang$core$List$member, _user$project$Types$MIHLKnobs, model.activeInfoBoxes) ? {
				ctor: '::',
				_0: _user$project$Views$highlightKIHInfo,
				_1: {ctor: '[]'}
			} : {ctor: '[]'}))));
};
							...
							return {
								...
								_0: A2(
									_elm_lang$html$Html$button,
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Events$onClick(
											_user$project$Types$RetrieveOptimisation(_p14)),
										_1: {ctor: '[]'}
									},
									{
										ctor: '::',
							...
							return {
								...
								_0: A2(
									_elm_lang$html$Html$button,
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Events$onClick(
											_user$project$Types$ClearOptimisation(_p14)),
										_1: {ctor: '[]'}
									},
									{
										ctor: '::',
	...
	return A2(
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('About (Ver 2.0.4)'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				...
				_1: {
					...
					_1: {
						...
						_1: {
							...
							_1: {
								ctor: '::',
								_0: _user$project$Views$optimisePanel(model),
								_1: {
									ctor: '::',
