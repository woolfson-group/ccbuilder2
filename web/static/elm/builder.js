...
var _user$project$Types$maybeNumberToString = function (mNum) {
	var _p0 = mNum;
	if (_p0.ctor === 'Just') {
...
var _user$project$Types$parameterRecordWithDefault = F2(
...
var _user$project$Types$inputRecordWithDefault = F2(
	function (iVID, inputValues) {
		return A2(
			_elm_lang$core$Maybe$withDefault,
			_user$project$Types$emptyInput,
			A2(_elm_lang$core$Dict$get, iVID, inputValues));
	});
var _user$project$Types$parametersToInput = function (parameterRecord) {
	var lsh = _elm_lang$core$Basics$toString(parameterRecord.linkedSuperHelRot);
	var zsh = _user$project$Types$maybeNumberToString(parameterRecord.zShift);
	var ant = _elm_lang$core$Basics$toString(parameterRecord.antiParallel);
	var rot = _user$project$Types$maybeNumberToString(parameterRecord.superHelRot);
	var reg = parameterRecord.register;
	var seq = A2(_elm_lang$core$Maybe$withDefault, '', parameterRecord.sequence);
	var phi = _user$project$Types$maybeNumberToString(parameterRecord.phiCA);
	var pit = _user$project$Types$maybeNumberToString(parameterRecord.pitch);
	var rad = _user$project$Types$maybeNumberToString(parameterRecord.radius);
	return A9(_user$project$Types$InputValues, rad, pit, phi, seq, reg, rot, ant, zsh, lsh);
};
var _user$project$Types$parametersDictToInputDict = function (parameters) {
...
var _user$project$Types$CloseInfo = {ctor: 'CloseInfo'};
var _user$project$Types$ShowInfo = function (a) {
	return {ctor: 'ShowInfo', _0: a};
};
...
var _user$project$Types$CheckOptJobs = function (a) {
	return {ctor: 'CheckOptJobs', _0: a};
};
var _user$project$Types$OptimisationSubmitted = function (a) {
	return {ctor: 'OptimisationSubmitted', _0: a};
};
var _user$project$Types$SetHeat = function (a) {
	return {ctor: 'SetHeat', _0: a};
};
var _user$project$Types$ProcessModel = function (a) {
	return {ctor: 'ProcessModel', _0: a};
};
var _user$project$Types$Optimise = {ctor: 'Optimise'};
...
var _user$project$Types$ChangeHelixType = function (a) {
	return {ctor: 'ChangeHelixType', _0: a};
};
var _user$project$Types$PasteParameters = function (a) {
	return {ctor: 'PasteParameters', _0: a};
};
var _user$project$Types$CopyParameters = function (a) {
	return {ctor: 'CopyParameters', _0: a};
};
var _user$project$Types$EditAllParameters = F2(
	function (a, b) {
		return {ctor: 'EditAllParameters', _0: a, _1: b};
	});
var _user$project$Types$EditSingleParameter = F3(
	function (a, b, c) {
...
var _user$project$Types$stringToHelixType = function (helixString) {
	...
	switch (_p5) {
		...
		case 'COLLAGEN':
			return _elm_lang$core$Result$Ok(_user$project$Types$Collagen);
		default:
			return _elm_lang$core$Result$Err('String could not be converted to HelixType.');
	}
};
...
var _user$project$Types$stringToOptStatus = function (statusString) {
	...
	switch (_p7) {
		...
		default:
			return _elm_lang$core$Result$Err('String could not be converted to OptStatus.');
	}
};
...
var _user$project$Types$MIInfo = {ctor: 'MIInfo'};
var _user$project$Types$BuildInfo = {ctor: 'BuildInfo'};
var _user$project$Types$stringToInfoBoxID = function (infoBoxString) {
	var _p8 = infoBoxString;
	switch (_p8) {
		case 'BuildInfo':
			return _elm_lang$core$Result$Ok(_user$project$Types$BuildInfo);
		case 'MIInfo':
			return _elm_lang$core$Result$Ok(_user$project$Types$MIInfo);
		default:
			return _elm_lang$core$Result$Err('String could not be converted to InfoBox.');
	}
};
...
var _user$project$BuilderCss$colorPalette = {
	...
	c3: _rtfeldman$elm_css$Css$hex('9fb8ad'),
	c4: _rtfeldman$elm_css$Css$hex('475841'),
	c5: _rtfeldman$elm_css$Css$hex('3f403f')
};
var _user$project$BuilderCss$panelStyling = {
	ctor: '::',
...
var _user$project$BuilderCss$cssNamespace = 'builder';
var _user$project$BuilderCss$ColorPalette = F5(
	function (a, b, c, d, e) {
		return {c1: a, c2: b, c3: c, c4: d, c5: e};
	});
var _user$project$BuilderCss$InfoPanelCss = {ctor: 'InfoPanelCss'};
var _user$project$BuilderCss$CCBButtonCss = {ctor: 'CCBButtonCss'};
var _user$project$BuilderCss$FlexCloseCss = {ctor: 'FlexCloseCss'};
...
var _user$project$BuilderCss$RightPanelToggleCss = {ctor: 'RightPanelToggleCss'};
var _user$project$BuilderCss$LeftPanelToggleCss = {ctor: 'LeftPanelToggleCss'};
...
var _user$project$BuilderCss$css = function (_p0) {
...
}(
	{
		...
		_0: _rtfeldman$elm_css$Css_Elements$body(
			{
				ctor: '::',
				_0: _rtfeldman$elm_css$Css$color(_user$project$BuilderCss$colorPalette.c5),
				_1: {
					ctor: '::',
					...
					_1: {
						...
						_1: {
							...
							_1: {
								...
								_0: A2(
									_rtfeldman$elm_css$Css$class,
									_user$project$BuilderCss$LeftPanelToggleCss,
									{
										ctor: '::',
								...
								_1: {
									...
									_0: A2(
										_rtfeldman$elm_css$Css$class,
										_user$project$BuilderCss$RightPanelToggleCss,
										{
											ctor: '::',
											_0: A2(_rtfeldman$elm_css$Css$property, 'writing-mode', 'vertical-rl'),
											_1: {
										...
										_1: {
															...
															_0: _rtfeldman$elm_css$Css$children(
																{
																	...
																	_1: {
																		...
																		_0: A2(
																			_rtfeldman$elm_css$Css$class,
																			_user$project$BuilderCss$FlexCloseCss,
																			{ctor: '[]'}),
																		_1: {ctor: '[]'}
																	}
																}),
											...
											_1: {
												...
												_1: {
													...
													_0: A2(
														_rtfeldman$elm_css$Css$class,
														_user$project$BuilderCss$InfoPanelCss,
														{
															ctor: '::',
...
var _user$project$ParameterValidation$isAllowedSeqCharCol = function ($char) {
	var allowed = {
		ctor: '::',
...
var _user$project$ParameterValidation$isAllowedSeqChar = function ($char) {
	var allowed = {
		ctor: '::',
		_0: _elm_lang$core$Native_Utils.chr('A'),
		_1: {
...
var _user$project$ParameterValidation$validateSequence = F2(
	function (sequence, helixType) {
		...
		var allValidChars = A2(
			_elm_lang$core$List$all,
			_elm_lang$core$Native_Utils.eq(helixType, _user$project$Types$Collagen) ? _user$project$ParameterValidation$isAllowedSeqCharCol : _user$project$ParameterValidation$isAllowedSeqChar,
...
var _user$project$ParameterValidation$validatePitch = function (pitch) {
	return ((_elm_lang$core$Native_Utils.cmp(pitch, 0) > 0) && _user$project$ParameterValidation$isNotNaN(pitch)) ? _elm_lang$core$Maybe$Just(pitch) : _elm_lang$core$Maybe$Nothing;
};
var _user$project$ParameterValidation$validateRadius = function (radius) {
	return ((_elm_lang$core$Native_Utils.cmp(radius, 0) > 0) && _user$project$ParameterValidation$isNotNaN(radius)) ? _elm_lang$core$Maybe$Just(radius) : _elm_lang$core$Maybe$Nothing;
};
var _user$project$ParameterValidation$editParameterValue = F5(
	function (parameters, currentInput, parameter, newValue, helixType) {
		var _p1 = parameter;
		switch (_p1.ctor) {
			case 'Radius':
			...
			case 'Sequence':
				var newInput = _elm_lang$core$Native_Utils.update(
					currentInput,
					{sequence: newValue});
				var validatedSequence = A2(_user$project$ParameterValidation$validateSequence, newValue, helixType);
				var newParameters = _elm_lang$core$Native_Utils.update(
					parameters,
...
var _user$project$ParameterValidation$containsInvalidParameter = function (_p2) {
	...
	var vRadius = !_elm_lang$core$Native_Utils.eq(_p3.radius, _elm_lang$core$Maybe$Nothing);
	return A2(
		_elm_lang$core$List$member,
		false,
		{
...
var _user$project$ParameterValidation$invalidParameterDict = function (parameters) {
	return A2(
		_elm_lang$core$List$any,
		function (b) {
			return _elm_lang$core$Native_Utils.eq(b, true);
		},
		A2(
			_elm_lang$core$List$map,
			...
			_elm_lang$html$Html$select,
			{
				...
				_1: {
					...
					_0: _elm_lang$html$Html_Events$onInput(
						A2(_user$project$Types$EditSingleParameter, _user$project$Types$Register, sectionID)),
					_1: {ctor: '[]'}
				}
			},
			A2(
...
var _user$project$BuildPanel$selectOligomericState = function (currentOS) {
	return A2(
		_elm_lang$html$Html$select,
		{
			ctor: '::',
		...
		A2(
			_elm_lang$core$List$map,
			function (_p0) {
				return _user$project$BuildPanel$simpleOption(
					_elm_lang$core$Basics$toString(_p0));
			},
			A2(_elm_lang$core$List$range, 2, 30)));
};
var _user$project$BuildPanel$selectHelixType = function (currentHelixType) {
	return A2(
		_elm_lang$html$Html$select,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$value(
				_elm_lang$core$Basics$toString(currentHelixType)),
			_1: {
				ctor: '::',
				_0: _elm_lang$html$Html_Events$onInput(_user$project$Types$ChangeHelixType),
				_1: {ctor: '[]'}
			}
		},
		A2(
...
var _user$project$BuildPanel$selectBuildMode = function (currentBuildMode) {
	return A2(
		_elm_lang$html$Html$select,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$value(
				_elm_lang$core$Basics$toString(currentBuildMode)),
			_1: {
				ctor: '::',
...
var _user$project$BuildPanel$allParameterInput = function (_p3) {
	var _p4 = _p3;
	var _p5 = _p4._0;
	return A2(
							...
							_1: {
								...
								_1: {
									...
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Events$onInput(
											_user$project$Types$EditAllParameters(_p4._1)),
										_1: {
											ctor: '::',
...
var _user$project$BuildPanel$parameterSubmit = F2(
				...
				_1: {
					...
					_1: {
						...
						_0: _elm_lang$html$Html_Attributes$disabled(
							_user$project$ParameterValidation$invalidParameterDict(parameters) || building),
						_1: {ctor: '[]'}
					}
				}
			},
	...
	function (helixType, buildMode, parametersDict, currentInputDict, building, visible) {
		...
		return A2(
			...
			A2(
				...
				A2(
					_elm_lang$core$Basics_ops['++'],
					_elm_lang$core$Native_Utils.eq(helixType, _user$project$Types$Alpha) ? {
						ctor: '::',
						_0: A2(
							_elm_lang$html$Html$h3,
							{ctor: '[]'},
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text('Oligomeric State'),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
							_0: _user$project$BuildPanel$selectOligomericState(
								_elm_lang$core$List$length(
									_elm_lang$core$Dict$toList(parametersDict))),
							_1: {ctor: '[]'}
						}
					} : {ctor: '[]'},
					{
						...
						_1: {
							ctor: '::',
							_0: A2(_user$project$BuildPanel$parameterSubmit, building, parametersDict),
							_1: {
								ctor: '::',
								_0: A2(
									_elm_lang$html$Html$button,
...
var _user$project$BuildPanel$toggleBuildPanel = A2(
	_elm_lang$html$Html$div,
	{
		ctor: '::',
		_0: _user$project$BuildPanel$class(
			{
				...
				_1: {
					ctor: '::',
					_0: _user$project$BuilderCss$LeftPanelToggleCss,
					_1: {ctor: '[]'}
				}
			}),
		_1: {
			ctor: '::',
			_0: _elm_lang$html$Html_Events$onClick(
				_user$project$Types$TogglePanel(_user$project$Types$BuildPanel)),
			_1: {ctor: '[]'}
		}
	},
	{
...
var _user$project$ExamplesPanel$makeHomoOligomerExample = F2(
	function (oligomericState, parameters) {
		return _elm_lang$core$Dict$fromList(
			A3(
				_elm_lang$core$List$map2,
				F2(
...
var _user$project$ExamplesPanel$x1f = function (_p1) {
	return _elm_lang$svg$Svg_Attributes$x1(
		_user$project$ExamplesPanel$toStringRound(_p1));
};
var _user$project$ExamplesPanel$y1f = function (_p2) {
	return _elm_lang$svg$Svg_Attributes$y1(
		_user$project$ExamplesPanel$toStringRound(_p2));
};
var _user$project$ExamplesPanel$x2f = function (_p3) {
	return _elm_lang$svg$Svg_Attributes$x2(
		_user$project$ExamplesPanel$toStringRound(_p3));
};
var _user$project$ExamplesPanel$y2f = function (_p4) {
...
var _user$project$ExamplesPanel$tau = 2 * _elm_lang$core$Basics$pi;
	...
	function (n, widthAndHeight) {
		...
		return A2(
			...
			A2(
				...
				A2(
					_elm_lang$core$List$map,
					_user$project$ExamplesPanel$drawHelixCircle(4),
					frameCoordinates)));
	});
...
var _user$project$ExamplesPanel$exampleCCButton = F3(
	function (os, exampleParameters, building) {
		return A2(
			...
			{
				ctor: '::',
				_0: A2(_user$project$ExamplesPanel$ccIcon, os, 40),
				_1: {ctor: '[]'}
			});
	});
...
var _user$project$Model$modelOptJobs = function (optJobs) {
	return A2(
		_elm_lang$core$List$map,
		function (_p0) {
			var _p1 = _p0;
			return {
				...
				_1: A2(
					...
					_user$project$Types$stringToOptStatus(_p1._1))
			};
		},
		optJobs);
};
var _user$project$Model$exportableOptJobs = function (optJobs) {
	return A2(
		_elm_lang$core$List$map,
		function (_p2) {
			var _p3 = _p2;
			return {
				ctor: '_Tuple2',
				_0: _p3._0,
				_1: _user$project$Types$optStatusToString(_p3._1)
			};
		},
		optJobs);
};
var _user$project$Model$exportableToModel = function (exportableModel) {
	return {
		parameters: _elm_lang$core$Dict$fromList(exportableModel.parameters),
		currentInput: _elm_lang$core$Dict$fromList(exportableModel.currentInput),
		parameterClipBoard: exportableModel.parameterClipBoard,
		oligomericState: exportableModel.oligomericState,
		helixType: _user$project$Types$Alpha,
		...
		modelHistory: _elm_lang$core$Dict$fromList(
			A2(
				_elm_lang$core$List$map,
				function (_p4) {
					var _p5 = _p4;
		...
		activeInfoBox: _elm_lang$core$Result$toMaybe(
			_user$project$Types$stringToInfoBoxID(exportableModel.activeInfoBox))
	};
};
var _user$project$Model$modelToExportable = function (model) {
	return {
		parameters: _elm_lang$core$Dict$toList(model.parameters),
		currentInput: _elm_lang$core$Dict$toList(model.currentInput),
		...
		activeInfoBox: _elm_lang$core$Basics$toString(model.activeInfoBox)
	};
};
...
var _user$project$Model$emptyModel = {
	...
	nextHistoryID: 1,
	panelVisibility: _user$project$Model$defaultVisibility,
	currentRepresentation: A5(_user$project$Types$Representation, false, true, true, false, false),
	activeInfoBox: _elm_lang$core$Maybe$Nothing
};
													...
													return function (n) {
														return function (o) {
															return function (p) {
																return function (q) {
																	return function (r) {
																		return {parameters: a, currentInput: b, parameterClipBoard: c, oligomericState: d, helixType: e, buildMode: f, pdbFile: g, score: h, residuesPerTurn: i, knobIDs: j, building: k, optJobs: l, heat: m, modelHistory: n, nextHistoryID: o, panelVisibility: p, currentRepresentation: q, activeInfoBox: r};
																	};
																};
															};
														};
...
var _user$project$Model$ExportableModel = function (a) {
	return function (b) {
		return function (c) {
			return function (d) {
				return function (e) {
											...
											return function (l) {
												return function (m) {
													return function (n) {
														return function (o) {
															return function (p) {
																return {parameters: a, currentInput: b, parameterClipBoard: c, oligomericState: d, pdbFile: e, score: f, residuesPerTurn: g, knobIDs: h, building: i, optJobs: j, heat: k, modelHistory: l, nextHistoryID: m, panelVisibility: n, currentRepresentation: o, activeInfoBox: p};
															};
														};
													};
												};
	...
	function (msg, model) {
		...
		switch (_p2.ctor) {
			case 'EditSingleParameter':
				var _p4 = _p2._1;
				var input = A2(_user$project$Types$inputRecordWithDefault, _p4, model.currentInput);
				var params = A2(_user$project$Types$parameterRecordWithDefault, _p4, model.parameters);
				var _p3 = A5(_user$project$ParameterValidation$editParameterValue, params, input, _p2._0, _p2._2, model.helixType);
				var p = _p3._0;
				var i = _p3._1;
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					_elm_lang$core$Native_Utils.update(
						model,
						{
							parameters: A3(_elm_lang$core$Dict$insert, _p4, p, model.parameters),
							currentInput: A3(_elm_lang$core$Dict$insert, _p4, i, model.currentInput)
						}),
					{ctor: '[]'});
				...
				return A2(
					...
					A2(
						...
						A3(
							...
							A2(_elm_lang$core$List$repeat, model.oligomericState, _p2._1),
							A2(
								_elm_lang$core$List$map,
								_user$project$Types$EditSingleParameter(_p2._0),
			...
			case 'CopyParameters':
				return A2(
					...
					_elm_lang$core$Native_Utils.update(
						model,
						{
							parameterClipBoard: A2(_elm_lang$core$Dict$get, _p2._0, model.parameters)
						}),
					{ctor: '[]'});
			case 'PasteParameters':
				...
				return A2(
					...
					_elm_lang$core$Native_Utils.update(
						model,
						{
							parameters: A3(_elm_lang$core$Dict$insert, _p5, pastedParameters, model.parameters),
							currentInput: A3(
								_elm_lang$core$Dict$insert,
								_p5,
								_user$project$Types$parametersToInput(pastedParameters),
								model.currentInput)
						}),
					{ctor: '[]'});
			case 'ChangeHelixType':
				var newHelixType = function () {
					var _p6 = _p2._0;
					switch (_p6) {
						case 'Alpha':
							return _user$project$Types$Alpha;
						case 'Collagen':
							return _user$project$Types$Collagen;
						default:
							return model.helixType;
					}
				}();
				var oligomericState = 3;
				var newParameters = function () {
					if (!_elm_lang$core$Native_Utils.eq(newHelixType, model.helixType)) {
						var _p7 = newHelixType;
						if (_p7.ctor === 'Collagen') {
							return (_elm_lang$core$Native_Utils.cmp(model.oligomericState, 3) > 0) ? _elm_lang$core$Dict$fromList(
								A2(
									_elm_lang$core$List$take,
									oligomericState,
									_elm_lang$core$Dict$toList(model.parameters))) : ((_elm_lang$core$Native_Utils.cmp(model.oligomericState, 3) < 0) ? _elm_lang$core$Dict$fromList(
								A3(
									_elm_lang$core$List$map2,
									F2(
										function (v0, v1) {
									...
									A2(
										...
										A2(
											...
											_elm_lang$core$List$head(
												_elm_lang$core$Dict$values(model.parameters)))))) : model.parameters);
						} else {
				...
				var newInput = _user$project$Types$parametersDictToInputDict(newParameters);
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					_elm_lang$core$Native_Utils.update(
						model,
						{helixType: newHelixType, oligomericState: oligomericState, parameters: newParameters, currentInput: newInput}),
					A2(
						_elm_lang$core$List$map,
						_user$project$Update$toCommand,
						A2(
							...
							function (_p8) {
								var _p9 = _p8;
								return A3(_user$project$Types$EditSingleParameter, _user$project$Types$Sequence, _p9._0, _p9._1);
							},
							A2(
								_elm_lang$core$List$map,
								function (_p10) {
									var _p11 = _p10;
									return {ctor: '_Tuple2', _0: _p11._0, _1: _p11._1.sequence};
								},
								_elm_lang$core$Dict$toList(newInput)))));
			case 'ChangeBuildMode':
				...
				var newParameters = function () {
					if (!_elm_lang$core$Native_Utils.eq(newBuildMode, model.buildMode)) {
						var _p13 = newBuildMode;
						if (_p13.ctor === 'Basic') {
							return _elm_lang$core$Dict$fromList(
								A3(
									_elm_lang$core$List$map2,
									...
									A2(
										_elm_lang$core$List$repeat,
										model.oligomericState,
										A2(
											_elm_lang$core$Maybe$withDefault,
											_user$project$Types$emptyParameterRecord,
											_elm_lang$core$List$head(
												_elm_lang$core$Dict$values(model.parameters))))));
						} else {
							return model.parameters;
						}
					} else {
				...
				return A2(
					...
					_elm_lang$core$Native_Utils.update(
						model,
						{buildMode: newBuildMode, parameters: newParameters, currentInput: newInput}),
					{
						ctor: '::',
						_0: A2(
							_elm_lang$core$Task$perform,
					...
					return A2(
						...
						_elm_lang$core$Native_Utils.update(
							model,
							{
								optJobs: {
									ctor: '::',
									_0: {ctor: '_Tuple2', _0: _p2._0._0, _1: _user$project$Types$Submitted},
									_1: model.optJobs
								}
							}),
						{
					...
					A2(
						...
						A2(
							...
							A2(
								...
								function (_p15) {
									var _p16 = _p15;
									return _elm_lang$core$Native_Utils.eq(_p16._1, _user$project$Types$Complete) ? false : true;
								},
								model.optJobs))));
			case 'OptJobStatus':
				if (_p2._0.ctor === 'Ok') {
					var newOptJobs = _elm_lang$core$Dict$toList(
						A3(
							...
							A2(
								_elm_lang$core$Result$withDefault,
								_user$project$Types$Failed,
								_user$project$Types$stringToOptStatus(_p2._0._0._1)),
			...
			case 'RetrieveOptimisation':
				...
				return A2(
					...
					{
						ctor: '::',
						_0: _user$project$Update$retreiveOptimisation(_p19),
						_1: {ctor: '[]'}
					});
			case 'ProcessModel':
				if (_p2._0.ctor === 'Ok') {
					var _p22 = _p2._0._0.score;
					var _p21 = _p2._0._0.pdbFile;
					var _p20 = _p2._0._0.knobIDs;
					var helixType = A2(
						_elm_lang$core$Result$withDefault,
						_user$project$Types$Alpha,
					...
					return A2(
						...
						_elm_lang$core$Native_Utils.update(
							model,
							{
								...
								score: _elm_lang$core$Maybe$Just(_p22),
								residuesPerTurn: _elm_lang$core$Maybe$Just(_p2._0._0.residuesPerTurn),
								knobIDs: _elm_lang$core$Maybe$Just(_p20),
								building: false,
								modelHistory: A3(
									_elm_lang$core$Dict$insert,
									model.nextHistoryID,
									{ctor: '_Tuple6', _0: model.parameters, _1: false, _2: _p22, _3: helixType, _4: _user$project$Types$Basic, _5: _p20},
									oldHistory),
			...
			case 'ProcessOptimisation':
				if (_p2._0.ctor === 'Ok') {
					var _p24 = _p2._0._0.parameters;
					var _p23 = _p2._0._0.oligomericState;
					var fullParameters = {
						radius: _p24.radius,
						pitch: _p24.pitch,
						phiCA: _p24.phiCA,
						sequence: _p24.sequence,
						register: _p24.register,
						antiParallel: false,
						linkedSuperHelRot: true,
					...
					var parametersDict = _elm_lang$core$Dict$fromList(
						A3(
							...
							A2(_elm_lang$core$List$range, 1, _p23),
							A2(_elm_lang$core$List$repeat, _p23, fullParameters)));
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						_elm_lang$core$Native_Utils.update(
							model,
							{
								...
								currentInput: _user$project$Types$parametersDictToInputDict(parametersDict)
							}),
						{
							ctor: '::',
							_0: _user$project$Update$toCommand(
								_user$project$Types$ProcessModel(
									_elm_lang$core$Result$Ok(_p2._0._0.modellingResults))),
							_1: {ctor: '[]'}
						});
				} else {
					return A2(
						...
						model,
						{
							...
							_0: _user$project$Update$toCommand(
								_user$project$Types$ProcessModel(
									_elm_lang$core$Result$Err(_p2._0._0))),
							_1: {ctor: '[]'}
						});
				}
				...
				return _user$project$ParameterValidation$invalidParameterDict(_p25) ? A2(
					...
					_elm_lang$core$Native_Utils.update(
						model,
						{
							...
							buildMode: _p2._2,
							parameters: _p25,
							currentInput: _user$project$Types$parametersDictToInputDict(_p25),
			...
			case 'TogglePanel':
				return A2(
					...
					_elm_lang$core$Native_Utils.update(
						model,
						{
							panelVisibility: A2(_user$project$Update$togglePanelVisibility, _p2._0, model.panelVisibility),
							activeInfoBox: _elm_lang$core$Maybe$Nothing
						}),
					{
						ctor: '::',
						...
						_elm_lang$core$Native_Utils.update(
							model,
							{
								modelHistory: A3(
									_elm_lang$core$Dict$insert,
									_p28,
									{ctor: '_Tuple6', _0: _p27._0._0, _1: !_p27._0._1, _2: _p27._0._2, _3: _p27._0._3, _4: _p27._0._4, _5: _p27._0._5},
									model.modelHistory)
							}),
						{ctor: '[]'});
				} else {
			...
			case 'EditRepresentation':
				var newRep = A2(_user$project$Update$updateRepresentation, _p2._0, model.currentRepresentation);
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					_elm_lang$core$Native_Utils.update(
						model,
			...
			case 'ShowInfo':
				...
				return A2(
					...
					_elm_lang$core$Native_Utils.update(
						model,
						{
							activeInfoBox: function () {
								var _p29 = model.activeInfoBox;
								if (_p29.ctor === 'Just') {
									return _elm_lang$core$Native_Utils.eq(_p30, _p29._0) ? _elm_lang$core$Maybe$Nothing : _elm_lang$core$Maybe$Just(_p30);
								} else {
									return _elm_lang$core$Maybe$Just(_p30);
								}
							}()
						}),
					{ctor: '[]'});
...
var _user$project$Views$getInformationText = function (infoBox) {
	var _p0 = infoBox;
	if (_p0.ctor === 'MIInfo') {
		return _user$project$Views$mIText;
	} else {
		return 'BLAH!';
	}
};
...
var _user$project$Views$styles = function (_p1) {
	return _elm_lang$html$Html_Attributes$style(
		_rtfeldman$elm_css$Css$asPairs(_p1));
};
				...
				_1: {
					...
					_1: {
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text('Pitch'),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text('Interface Angle'),
									_1: {ctor: '[]'}
								}),
							_1: {
								ctor: '::',
...
var _user$project$Views$_p2 = _rtfeldman$elm_css_helpers$Html_CssHelpers$withNamespace(_user$project$BuilderCss$cssNamespace);
var _user$project$Views$class = _user$project$Views$_p2.$class;
var _user$project$Views$classList = _user$project$Views$_p2.classList;
var _user$project$Views$id = _user$project$Views$_p2.id;
		...
		_0: A2(
			...
			},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('CCBuilder 2.0'),
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			}),
...
var _user$project$Views$optimisePanel = F4(
	function (buildMode, optJobs, visible, heat) {
		...
		var disabledOpt = advancedBuild || optimising;
		return A2(
			_elm_lang$html$Html$div,
			{
				ctor: '::',
			...
			},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('Optimise Parameters'),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
...
var _user$project$Views$toggleOptimisePanel = A2(
	_elm_lang$html$Html$div,
	{
		...
		_1: {
			ctor: '::',
			_0: _elm_lang$html$Html_Events$onClick(
				_user$project$Types$TogglePanel(_user$project$Types$OptimisePanel)),
			_1: {ctor: '[]'}
		}
	},
	{
		...
		},
		{
			...
			_0: A2(
				...
				},
				{
					...
					_1: {
						ctor: '::',
						_0: _user$project$Views$informationButton(_user$project$Types$MIInfo),
						_1: {ctor: '[]'}
					}
				}),
			_1: {
...
var _user$project$Views$modelParametersAsRow = F2(
	function (_p4, building) {
		...
		var foldedRows = A2(
			_elm_lang$core$List$map,
			_user$project$Views$modelFoldedRow(_p10),
			A2(
				_elm_lang$core$Maybe$withDefault,
				{ctor: '[]'},
				_elm_lang$core$List$tail(
					_elm_lang$core$Dict$values(_p9))));
		return (!_p11) ? {
			ctor: '::',
			_0: A7(_user$project$Views$modelHistoryTopRow, _p7, _p9, building, _p11, _p10, _p8, _p6),
			_1: {ctor: '[]'}
		} : {
			ctor: '::',
			_0: A7(_user$project$Views$modelHistoryTopRow, _p7, _p9, building, _p11, _p10, _p8, _p6),
...
var _user$project$Views$toggleBuildHistoryPanel = A2(
	_elm_lang$html$Html$div,
	{
		...
		_1: {
			ctor: '::',
			_0: _elm_lang$html$Html_Events$onClick(
				_user$project$Types$TogglePanel(_user$project$Types$BuildHistoryPanel)),
			_1: {ctor: '[]'}
		}
	},
	{
	...
	return A2(
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Viewer Options'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
...
var _user$project$Views$showInfoBox = function (infoBox) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			...
			_1: {
				ctor: '::',
				_0: _user$project$Views$styles(
					A2(_elm_lang$core$Basics_ops['++'], _user$project$Views$showInfoBoxStyling, _user$project$BuilderCss$panelStyling)),
				_1: {ctor: '[]'}
			}
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Information'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: A2(
					...
					{ctor: '[]'},
					_user$project$Views$getInformationText(infoBox)),
				_1: {
					ctor: '::',
					_0: A2(
						_elm_lang$html$Html$div,
						...
						return {
							...
							_0: A2(
								_elm_lang$html$Html$button,
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Events$onClick(
										_user$project$Types$RetrieveOptimisation(_p13._0)),
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
...
var _user$project$Views$overlayPanels = function (model) {
	var panelDivs = A2(
		...
		A2(
			_elm_lang$core$Basics_ops['++'],
			function () {
				var _p16 = model.activeInfoBox;
				if (_p16.ctor === 'Just') {
					return {
						ctor: '::',
						_0: _user$project$Views$showInfoBox(_p16._0),
						_1: {ctor: '[]'}
					};
				} else {
					return {ctor: '[]'};
			...
			A3(
				...
				A2(
					_elm_lang$core$List$range,
					1,
					_elm_lang$core$List$length(model.optJobs)))));
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		panelDivs);
																			...
																			return A2(
																				...
																				function (spheres) {
																					return A2(
																						...
																						function (trace) {
																							return _elm_lang$core$Json_Decode$succeed(
																								{ballsAndSticks: ballsAndSticks, cartoon: cartoon, points: points, spheres: spheres, trace: trace});
																						},
																						A2(_elm_lang$core$Json_Decode$field, 'trace', _elm_lang$core$Json_Decode$bool));
																				},
																				A2(_elm_lang$core$Json_Decode$field, 'spheres', _elm_lang$core$Json_Decode$bool));
																		},
																		A2(_elm_lang$core$Json_Decode$field, 'points', _elm_lang$core$Json_Decode$bool));
																},
																A2(_elm_lang$core$Json_Decode$field, 'cartoon', _elm_lang$core$Json_Decode$bool));
														},
														A2(_elm_lang$core$Json_Decode$field, 'ballsAndSticks', _elm_lang$core$Json_Decode$bool))));
										},
										A2(
											_elm_lang$core$Json_Decode$field,
											'currentInput',
																														...
																														return A2(
																															...
																															function (superHelRot) {
																																return A2(
																																	...
																																	A2(_elm_lang$core$Json_Decode$field, 'zShift', _elm_lang$core$Json_Decode$string));
																															},
																															A2(_elm_lang$core$Json_Decode$field, 'superHelRot', _elm_lang$core$Json_Decode$string));
																													},
																													A2(_elm_lang$core$Json_Decode$field, 'sequence', _elm_lang$core$Json_Decode$string));
																											},
																											A2(_elm_lang$core$Json_Decode$field, 'register', _elm_lang$core$Json_Decode$string));
																									},
																									A2(_elm_lang$core$Json_Decode$field, 'radius', _elm_lang$core$Json_Decode$string));
																							},
																							A2(_elm_lang$core$Json_Decode$field, 'pitch', _elm_lang$core$Json_Decode$string));
																					},
																					A2(_elm_lang$core$Json_Decode$field, 'phiCA', _elm_lang$core$Json_Decode$string));
																			},
																			A2(_elm_lang$core$Json_Decode$field, 'linkedSuperHelRot', _elm_lang$core$Json_Decode$string));
																	},
																	A2(_elm_lang$core$Json_Decode$field, 'antiParallel', _elm_lang$core$Json_Decode$string))));
													},
													A2(_elm_lang$core$Json_Decode$index, 0, _elm_lang$core$Json_Decode$int)))));
								},
								A2(_elm_lang$core$Json_Decode$field, 'building', _elm_lang$core$Json_Decode$bool));
						},
						A2(_elm_lang$core$Json_Decode$field, 'activeInfoBox', _elm_lang$core$Json_Decode$string))),
				_1: {ctor: '[]'}
			}
		}));
